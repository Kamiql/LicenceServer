package dev.kamiql.api.auth.discord
...
import dev.kamiql.model.auth.discord.OAuthTokenResponse
    ...
    get("/callback") {
        ...
        val tokenResponse: OAuthTokenResponse = http.submitForm(
            ...
            formParameters = Parameters.build {
                ...
                append("code", code)
                append("redirect_uri", "http://localhost:8080/api/callback")
            },
        ) {
        ...
        call.respondRedirect("/app/home", true)
    }
}